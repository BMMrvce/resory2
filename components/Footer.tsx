    ...
    <footer className="bg-primary-950 text-white border-t border-white/5 pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              />
              <span className="text-3xl font-serif font-bold text-glow text-accent-sand">
                Shine Lavish
              </span>
            </div>
            <p className="text-gray-400 leading-relaxed font-light">
              Experience the ultimate luxury amidst nature. A perfect blend of
              comfort, adventure, and tranquility awaiting your arrival.
            </p>
            <div className="flex space-x-4 pt-2">
              <a
                href="#"
                className="p-3 bg-white/5 rounded-full hover:bg-primary-600 hover:text-white transition-all duration-300 border border-white/5 hover:border-primary-500"
              >
                <Instagram size={20} />
              </a>
              <a
          ...
          {/* Quick Links */}
          <div className="space-y-6">
            <h3 className="text-xl font-serif font-semibold text-accent-gold">
              Quick Explore
            </h3>
            <ul className="space-y-3">
              <li>
                <button
                  ...
                  className="text-gray-400 hover:text-accent-sand hover:translate-x-2 inline-block transition-transform duration-300"
                >
                  Our Accommodations
                </button>
              </li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-center items-center text-center text-gray-500 text-sm gap-4">
          <p>
            &copy; {new Date().getFullYear()} Shine Lavish Retreat. All rights
            reserved.
          </p>
