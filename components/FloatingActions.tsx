...
const FloatingActions: React.FC = () => {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      {/* Directions Button */}
      <a 
        href="https://maps.app.goo.gl/rihsK8oVNDVtfQTT8" 
        target="_blank" 
        rel="noopener noreferrer"
        className="p-4 bg-blue-600 hover:bg-blue-500 text-white rounded-full shadow-[0_0_20px_rgba(37,99,235,0.4)] transition-all hover:scale-110 flex items-center justify-center group"
