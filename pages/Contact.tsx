...
import { Send, CheckCircle, AlertCircle, Calendar, MapPin, Phone, Mail } from 'lucide-react';
    ...
    <section id="contact" className="py-24 px-4 flex items-center justify-center relative scroll-mt-24">
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-6 bg-primary-950/40 p-6 md:p-8 rounded-2xl border border-white/5 backdrop-blur-md shadow-xl">
             <div className="flex items-start space-x-5 group">
                ...
                <div>
                  ...
                  <p className="text-gray-300 font-light text-sm leading-relaxed">Forest Valley Rd, Green Hills,<br/>Munnar, Kerala 685612</p>
                </div>
              </div>
        ...
        <div className="glass-card p-6 md:p-10 rounded-[2rem] shadow-2xl relative overflow-hidden order-1 lg:order-2">
           ...
           <h2 className="text-2xl md:text-3xl font-serif font-bold text-white mb-8 relative z-10 border-b border-white/10 pb-4 inline-block">Enquiry Form</h2>
