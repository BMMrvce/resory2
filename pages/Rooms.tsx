    ...
    <section id="accommodations" className="pt-4 pb-16 px-6 scroll-mt-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="flex overflow-x-auto pb-8 gap-6 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-10 md:overflow-visible md:pb-0 snap-x snap-mandatory -mx-6 px-6 md:mx-0 md:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] md:[&>div:nth-last-child(1)]:md:col-start-1 md:[&>div:nth-last-child(1)]:md:col-span-2 md:[&>div:nth-last-child(1)]:md:justify-self-center lg:[&>div:nth-last-child(1)]:lg:col-start-2 lg:[&>div:nth-last-child(1)]:lg:col-span-1">
            {ROOMS.map((room) => (
              <div
                key={room.id}
